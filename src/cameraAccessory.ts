...
export class CameraAccessory {
  ...
  private getVideoConfig(): VideoConfig {
    ...
    const stillImageSource =
      ...
      `-rtsp_transport ${rtspTransport} -buffer_size 512000 -max_delay 500000 -use_wallclock_as_timestamps 1 -fflags +genpts+igndts -timeout 5000000 -analyzeduration 500000 -probesize 500000 -i ${subStreamUrl}`;
    ...
    const config: VideoConfig = {
      ...
      source: `-rtsp_transport ${rtspTransport} -buffer_size 1024000 -max_delay 500000 -use_wallclock_as_timestamps 1 -fflags +genpts+igndts -timeout 5000000 -analyzeduration 1000000 -probesize 1000000 -i ${streamUrl}`,
    };
